...
document
  .querySelector(".wrap_list")
  .addEventListener("click", function (event) {
    if (
      event.target.classList.contains("profile_img") ||
      event.target.classList.contains("infor") ||
      event.target.classList.contains("image") ||
      event.target.classList.contains("other_nick") ||
      ...
      $.ajax({
        ...
        success: function (response) {
          ...
          document
            .querySelector(".adopt_btn")
            .setAttribute("data-room-id", roomId);
          document
            .querySelector(".view_btn")
            .setAttribute("data-room-id", roomId);
          ...
          document
            .querySelector(".view_btn")
            .setAttribute("post_id", foundData.post_id);
...
$(document).ready(function () {
  var chatSocket = new WebSocket("ws://" + "3.36.130.108:8080" + "/ws/chat/");
